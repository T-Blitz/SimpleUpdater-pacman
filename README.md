...
Make sure yo uare using pacman and not apt, npm, etc!
...
```
Run the "SimpleUpdater.desktop" file, each time you wish to Upgrade your System and or want to Reboot / Shutdown 
